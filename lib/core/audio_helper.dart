...
Future<AudioHandler> initAudioService() async {
  return await AudioService.init(
      ...
      config: const AudioServiceConfig(
        androidNotificationChannelId: 'audiobooks',
        androidNotificationChannelName: 'Samandar',
...
class CustomAudioHandler extends BaseAudioHandler {
  ...
  Future<void> addQueueItems(List<MediaItem> mediaItems) async {
    debugPrint('These are added queues $mediaItems');
  ...
  Future<void> updateQueue(List<MediaItem> queue) async {
    debugPrint('These are added queues $queue');
